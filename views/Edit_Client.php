      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            <div class="row">
              <div class="col-xs-12">
                <h4 class="page-title">Edit Clients</h4>
              </div> 
            </div>
			<!-- PAGE CONTENT HERE -------------------------->
            ...
            <tbody>
                <?php foreach ($Clients as $Client): ?>
                    <tr>
                        ...
                        <td>
                        <form id="ClientsForm" method="post" action="<?php echo admin_url('crud/EditClient'); ?>">
                        <input type="hidden" name="csrf_token_name" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                        <input type="hidden" name="id" value="<?php echo $Client['id']; ?>">
                        <button type="Delete" class="btn btn-primary mt-3">Edit Client</button>
                        </form>
